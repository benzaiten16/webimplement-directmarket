	...
	*/
	...
	$('#registrar_fechaNac').on('input', function(){
        ...
        $("#registrar_submit button").click(function(event){
            ...
            var form_data=$("form#registrar :not('#dropdown,#registrar_nombreComp,#registrar_URLweb,#dropdown2,#registrar_notificacionesorden,#registrar_notificacionesprod')").serializeArray();;
